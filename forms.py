...
class LoginForm(FlaskForm):
    ...
    ), Email()], render_kw={"placeholder": "Enter Password"})
...
class NewPasswordForm(FlaskForm):
    password = PasswordField("Password", validators=[
                             DataRequired(), Email()], render_kw={"placeholder": "New Password"})
    confrim_password = PasswordField("Password", validators=[
                                     DataRequired(), Email()], render_kw={"placeholder": "Confirm Password"})
    submit = SubmitField("Change Password")


class OTPForm(FlaskForm):
    otp = IntegerField("OTP", validators=[DataRequired()], render_kw={
